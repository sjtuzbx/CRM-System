...
layui.define(function(e) {
    ...
    u.prototype.view = function() {
        ...
        a.groups < 0 ? a.groups = 0 : a.groups > a.pages && (a.groups = a.pages),
        a.prev = "prev" in a ? a.prev: "&#x4E0A;&#x4E00;&#x9875;",
        a.next = "next" in a ? a.next: "&#x4E0B;&#x4E00;&#x9875;";
        var t = a.pages > a.groups ? Math.ceil((a.curr + (a.groups > 1 ? 1 : 0)) / (a.groups > 0 ? a.groups: 1)) : 1,
        r = {
            prev: function() {
            ...
            page: function() {
                ...
                return a.pages > a.groups && a.pages > i && a.last !== !1 && (i + 1 < a.pages && e.push('<span class="layui-laypage-spr">&#x2026;</span>'), 0 !== a.groups && e.push('<a href="javascript:;" class="layui-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' + a.pages + '">' + (a.last || a.pages) + "</a>")),
                e.join("")
            } (),
            next: function() {
            ...
            limit: function() {
                ...
                function(t, r) {
                    e.push('<option value="' + r + '"' + (r === a.limit ? "selected": "") + ">" + r + " Rows/Page</option>")
                }),
                e.join("") + "</select></span>"
            } (),
            skip: function() {
    ...
    u.prototype.jump = function(e, a) {
        if (e) {
            ...
            if (a) return o();
            for (var c = 0,
            g = i.length; c < g; c++)"a" === i[c].nodeName.toLowerCase() && s.on(i[c], "click",
            function() {
            ...
            function() {
                var e = this.value;
                n.curr * e > n.count && (n.curr = Math.ceil(n.count / e)),
                n.limit = e,
                t.render()
            }),
            u && s.on(u, "click",
    ...
    u.prototype.render = function(e) {
        ...
        i = r.type(),
        u = r.view();
        2 === i ? n.elem && (n.elem.innerHTML = u) : 3 === i ? n.elem.html(u) : a[t](n.elem) && (a[t](n.elem).innerHTML = u),
        n.jump && n.jump(n, e);
